        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">ADD Data Penilaian</h3>
              <p class="pull-right">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('penilaian/save');?>" method="POST">
              <div class="box-body">
              <div class="col-md-12">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="penerimaID" required>
                  <option Value=''>Pilih Opsi</option>
                    <?php
                    foreach($penerima AS $rows){
                    ?>
                    <option Value='<?php echo $rows->penerimaID; ?>'><?php echo $rows->penerimaNoKK.' | '.$rows->penerimaName; ?></option>
                    <?php
                    }
                    ?>
                  </select>
