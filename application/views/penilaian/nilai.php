      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('penilaian/savenilai/'.$row1->penilaianID);?>" method="POST">
            <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputPassword1">Pilih KK</label>
                  <select class="form-control select2" name="penilaianID" required readOnly>
                  <option Value='<?php echo $row1->penilaianID; ?>'><?php echo $row1->penerimaNoKK.' | '.$row1->penerimaName; ?></option>
                  </select>
                </div>
              </div>
              
              <?php $no=1; foreach($kriteria as $rowk){?>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputEmail1"><?php echo $rowk->criteriaName ?></label>
                  <input type="text" class="form-control" name="<?php echo 'C'.$no;?>" placeholder="Masukan Nilai.." required>
                </div>
                </div>
                <?php
                $no++;
