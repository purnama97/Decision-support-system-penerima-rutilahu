        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Update Kriteria Penilaian</h3>
              <p class="pull-right">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('kriteria/update/'.$row->criteriaID);?>" method="POST">
            <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Kriteria</label>
                  <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Kriteria.." required value="<?php echo $row->criteriaName; ?>">
                </div>
                </div>
                <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputEmail1">Bobot</label>
                  <input type="text" class="form-control" name="bobot" placeholder="Masukan Bobot.." required value="<?php echo $row->criteriaWeight; ?>">
                </div>
                </div>
              </div>
